    ...
    <el-col :span="12"><div class="grid-content bg-purple">
      <el-form ref="queryForm" :model="queryParams" :inline="true">
        ...
        <el-form-item>
          ...
          <el-button type="primary" icon="el-icon-saomiao" size="mini" @click="handleQuery">扫描二维码</el-button>
      ...
      <div class="grid-content bg-purple-light">
        <el-form ref="elForm" :model="formData" :rules="rules" size="mini">
          <el-card class="box-card">
            ...
            <el-row :gutter="20">
              <el-col :span="16" style="width: 300px;">
                <el-form-item label="证件类型" prop="field129" label-width="100px">
              ...
              <el-col :span="12" style="width: 300px;">
                <el-form-item label="证件号码" prop="field130" label-width="80px">
                  <el-input v-model="formData.field130" placeholder="请输入证件号码" clearable :style="{width: '97%'}" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="20">
            ...
            <el-row :gutter="20">
              <el-col :span="12" style="width: 300px;">
                <el-form-item label="腋温测量最高  " prop="twds" lable-width="250px">
                  <el-input v-model="formData.twds" placeholder="请输入腋温测量最高  " clearable :style="{width: '150px'}">
          ...
          <el-card class="box-card">
            ...
            <el-row>
              <el-col><template slot="">2. 发病前4周内旅行史，以及所来自国家/地区是否流行同类症状的疾病：</template>
              </el-col>
              <el-col>
                <template slot="" style="color: #ff0000"><font color="#ff0000">注意，有4条数据，开发自己扩展</font></template>
              </el-col>
            </el-row>
            <el-row>

              <el-col :span="6">
                <el-form-item label="国家地区" prop="lygj">
                  <el-input v-model="formData.lygj" placeholder="请输入国家地区" clearable :style="{width: '100%'}" />
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="城市" prop="lycs">
                  <el-input v-model="formData.lycs" placeholder="请输入城市" clearable :style="{width: '100%'}" />
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="离开地区" prop="lkdq">
                  <el-input v-model="formData.lkdq" placeholder="请输入离开地区" clearable :style="{width: '100%'}" />
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="来自国家/地区是否流行同类症状的疾病" prop="lyyn">
                  <el-select
                    v-model="formData.lyyn"
                    placeholder="请选择来自国家/地区是否流行同类症状的疾病"
                    clearable
                    :style="{width: '100%'}"
                  >
                    <el-option
                      v-for="(item, index) in lyynOptions"
                      :key="index"
                      :label="item.label"
                      :value="item.value"
                      :disabled="item.disabled"
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="3. 发病前14天内 是 否 接触新型冠状病毒感染者或其密切接触者" prop="field200">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="4. 发病前14天内 是 否 接触有发热、干咳症状的人" prop="field201">
            ...
            <el-row>
              <el-col><template slot="">以上2项如果有，填写类似症状人员情况表</template></el-col>
            </el-row>

            <el-row :gutter="20">
              <el-col :span="9">
                <el-form-item label="病人姓名" prop="field202">
                  <el-input v-model="formData.field202" placeholder="请输入病人姓名" clearable :style="{width: '100%'}" />
                </el-form-item>
              </el-col>
              <el-col :span="9">
                <el-form-item label="发病时间" prop="field203">
                  <el-date-picker
                    v-model="formData.field203"
                    format="yyyy-MM-dd"
                    value-format="yyyy-MM-dd"
                    :style="{width: '100%'}"
                    placeholder="请选择发病时间"
              ...
              <el-col :span="9">
                <el-form-item label="临床诊断" prop="field204">
                  <el-input v-model="formData.field204" placeholder="请输入临床诊断" clearable :style="{width: '100%'}" />
                </el-form-item>
              </el-col>
              <el-col :span="9">
                <el-form-item label="与本人关系" prop="field205">
                  <el-select v-model="formData.field205" placeholder="请选择与本人关系" clearable :style="{width: '100%'}">
                    <el-option
                      v-for="(item, index) in field205Options"
                      :key="index"
                      :label="item.label"
                      :value="item.value"
                      :disabled="item.disabled"
              ...
              <el-col :span="9">
                <el-form-item label="最后接触时间" prop="field206">
                  <el-date-picker
                    v-model="formData.field206"
                    format="yyyy-MM-dd"
                    value-format="yyyy-MM-dd"
                    :style="{width: '100%'}"
                    placeholder="请选择最后接触时间"
                    clearable
                  />
                </el-form-item>
              </el-col>
              <el-col :span="9">
                <el-form-item label="接触方式" prop="field207">
                  <el-select v-model="formData.field207" placeholder="请选择接触方式" clearable :style="{width: '100%'}">
                    <el-option
                      v-for="(item, index) in field207Options"
                      :key="index"
                      :label="item.label"
                      :value="item.value"
                      :disabled="item.disabled"
              ...
              <el-col :span="9">
                <el-form-item label="接触频率" prop="field208">
                  <el-select v-model="formData.field208" placeholder="请选择接触频率" clearable :style="{width: '100%'}">
                    <el-option
                      v-for="(item, index) in field208Options"
                      :key="index"
                      :label="item.label"
                      :value="item.value"
                      :disabled="item.disabled"
              ...
              <el-col :span="9">
                <el-form-item label="接触地点" prop="field209">
                  <el-select v-model="formData.field209" placeholder="请选择接触地点" clearable :style="{width: '100%'}">
                    <el-option
                      v-for="(item, index) in field209Options"
                      :key="index"
                      :label="item.label"
                      :value="item.value"
                      :disabled="item.disabled"
            ...
            <el-row>
              <el-col :span="21">
                <el-form-item label="发病前14天内 有 无野生动物、禽鸟类接触史" prop="field219">
            ...
            <el-row>
              <el-col :span="21">
                <el-form-item label="有无重点关注传染病预防接种史" prop="field228">
            ...
            <el-row>
              <el-col :span="21">
                <el-form-item label="如果有，具体接种情况是" prop="field229">
                  <el-input
                    v-model="formData.field229"
                    type="textarea"
                    placeholder="请输入具体接种情况"
                    :autosize="{minRows: 4, maxRows: 4}"
                    :style="{width: '100%'}"
                  />
                </el-form-item>
            ...
            <el-row>
              <el-col :span="21">
                <el-form-item label="近期有 无 不详用药" prop="field232">
            ...
            <el-row>
              <el-col :span="21">
                <el-form-item label="初步判断及病例处理意见" prop="field241">
                  <el-radio-group v-model="formData.field241" size="medium">
                    <el-radio
